...
// Import db.js so all tables are created before we seed
...
const users = [
  { name: "Ramakrishnan",    email: "admin@ccrts.com",      role: "admin" },
  { name: "Ananya Sharma",   email: "supervisor@ccrts.com", role: "supervisor" },
  { name: "Arjun Mehta",     email: "agent1@ccrts.com",     role: "agent" },
  { name: "Priya Nair",      email: "agent2@ccrts.com",     role: "agent" },
  { name: "Karthik Rajan",   email: "agent3@ccrts.com",     role: "agent" },
  { name: "Deepa Iyer",      email: "quality@ccrts.com",    role: "quality" },
  { name: "Anjali Verma",    email: "anjali@email.com",     role: "customer" },
  { name: "Rohit Sharma",    email: "rohit@email.com",      role: "customer" },
  { name: "Meena Pillai",    email: "meena@email.com",      role: "customer" },
  { name: "Vikram Nair",     email: "vikram@email.com",     role: "customer" },
  { name: "Sneha Reddy",     email: "sneha@email.com",      role: "customer" },
];

users.forEach((u) =>
  insertUser.run(u.name, u.email, hash("Password@123"), u.role)
);
...
const insertComplaint = db.prepare(`
  INSERT INTO complaints
    (complaint_id, customer_name, email, phone, category, priority,
     assigned_to, description, status, sla_deadline, resolved_at, created_at)
  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
`);

const complaints = [
  // Resolved complaints (older, for reports/history)
  {
    id: "CMP-001", name: "Anjali Verma", email: "anjali@email.com",
    phone: "9876543210", cat: "Billing", priority: "High",
    agent: "Arjun Mehta", status: "Resolved",
    desc: "Was charged twice for the same invoice #INV-2024-0891 in March. Need immediate refund.",
    daysAgo: 15, resolvedDaysAgo: 12,
  },
  {
    id: "CMP-002", name: "Rohit Sharma", email: "rohit@email.com",
    phone: "9876543211", cat: "Technical Support", priority: "Critical",
    agent: "Priya Nair", status: "Resolved",
    desc: "Complete service outage on our end since 6 AM. Multiple users affected. URGENT.",
    daysAgo: 20, resolvedDaysAgo: 19,
  },
  {
    id: "CMP-003", name: "Meena Pillai", email: "meena@email.com",
    phone: "9876543212", cat: "Delivery", priority: "Medium",
    agent: "Karthik Rajan", status: "Closed",
    desc: "Order #ORD-7823 was supposed to arrive 5 days ago. No tracking update available.",
    daysAgo: 25, resolvedDaysAgo: 22,
  },
  {
    id: "CMP-004", name: "Vikram Nair", email: "vikram@email.com",
    phone: "9876543213", cat: "Product Quality", priority: "High",
    agent: "Arjun Mehta", status: "Resolved",
    desc: "Laptop screen has dead pixels appeared after just 2 weeks of use. Under warranty.",
    daysAgo: 18, resolvedDaysAgo: 14,
  },
  {
    id: "CMP-005", name: "Sneha Reddy", email: "sneha@email.com",
    phone: "9876543214", cat: "Billing", priority: "Low",
    agent: "Priya Nair", status: "Closed",
    desc: "Requesting itemised bill for last 3 months for tax purposes.",
    daysAgo: 30, resolvedDaysAgo: 28,
  },
  {
    id: "CMP-006", name: "Anjali Verma", email: "anjali@email.com",
    phone: "9876543210", cat: "Customer Service", priority: "Medium",
    agent: "Karthik Rajan", status: "Resolved",
    desc: "Agent was rude during last call. Would like this escalated to management.",
    daysAgo: 12, resolvedDaysAgo: 10,
  },

  // Active complaints in various stages
  {
    id: "CMP-007", name: "Rohit Sharma", email: "rohit@email.com",
    phone: "9876543211", cat: "Technical Support", priority: "High",
    agent: "Arjun Mehta", status: "In Progress",
  ...
  {
    id: "CMP-008", name: "Meena Pillai", email: "meena@email.com",
    phone: "9876543212", cat: "Billing", priority: "Critical",
    agent: "Priya Nair", status: "Escalated",
    desc: "Account was debited ₹15,000 without any service being rendered. This is fraud.",
    daysAgo: 2, resolvedDaysAgo: null,
  },
  {
    id: "CMP-009", name: "Vikram Nair", email: "vikram@email.com",
    phone: "9876543213", cat: "Delivery", priority: "Medium",
    agent: "Karthik Rajan", status: "Assigned",
    desc: "Package marked as delivered but never received. Neighbours confirm they didn't take it.",
    daysAgo: 1, resolvedDaysAgo: null,
  },
  {
    id: "CMP-010", name: "Sneha Reddy", email: "sneha@email.com",
    phone: "9876543214", cat: "Product Quality", priority: "High",
    agent: "Arjun Mehta", status: "Pending Customer Response",
    desc: "Headphones stopped working after 3 months. Left ear unit completely silent.",
    daysAgo: 4, resolvedDaysAgo: null,
  },
  {
    id: "CMP-011", name: "Anjali Verma", email: "anjali@email.com",
    phone: "9876543210", cat: "Technical Support", priority: "Low",
  ...
  {
    id: "CMP-012", name: "Rohit Sharma", email: "rohit@email.com",
    phone: "9876543211", cat: "Customer Service", priority: "Medium",
    agent: "Priya Nair", status: "In Progress",
    desc: "Subscription plan was not downgraded as requested last week. Still being charged premium.",
    daysAgo: 2, resolvedDaysAgo: null,
  },
  {
    id: "CMP-013", name: "Meena Pillai", email: "meena@email.com",
    phone: "9876543212", cat: "Billing", priority: "High",
    agent: null, status: "Open",
  ...
  {
    id: "CMP-014", name: "Vikram Nair", email: "vikram@email.com",
    phone: "9876543213", cat: "Technical Support", priority: "Critical",
    agent: "Karthik Rajan", status: "Escalated",
  ...
  {
    id: "CMP-015", name: "Sneha Reddy", email: "sneha@email.com",
    phone: "9876543214", cat: "Delivery", priority: "Low",
    agent: "Arjun Mehta", status: "Assigned",
...
complaints.forEach((c) => {
  ...
  insertComplaint.run(
    c.id, c.name, c.email, c.phone, c.cat, c.priority,
    c.agent, c.desc, c.status, sla, resolved, created
  );
});
...
const histories = [
  // CMP-001 (Resolved)
  ["CMP-001", 3, null,          "Open",        "Complaint received from customer.", daysAgo(15)],
  ["CMP-001", 3, "Open",        "Assigned",    "Assigned to Arjun Mehta for investigation.", daysAgo(14, 20)],
  ["CMP-001", 3, "Assigned",    "In Progress", "Contacted billing team. Verifying duplicate charge.", daysAgo(14)],
  ["CMP-001", 3, "In Progress", "Resolved",    "Duplicate charge confirmed. Refund of ₹2,450 processed. Ref: REF-8821.", daysAgo(12)],

  // CMP-002 (Resolved Critical)
  ["CMP-002", 4, null,          "Open",        "Critical outage reported.", daysAgo(20)],
  ["CMP-002", 4, "Open",        "Assigned",    "Assigned to Priya Nair — critical priority.", daysAgo(20, 22)],
  ["CMP-002", 4, "Assigned",    "In Progress", "Infrastructure team alerted. Investigating root cause.", daysAgo(19, 20)],
  ["CMP-002", 4, "In Progress", "Resolved",    "Root cause: expired SSL certificate on load balancer. Renewed. Service restored.", daysAgo(19)],

  // CMP-003 (Closed)
  ["CMP-003", 5, null,          "Open",        "Delivery delay reported.", daysAgo(25)],
  ["CMP-003", 5, "Open",        "Assigned",    "Assigned to Karthik Rajan.", daysAgo(24)],
  ["CMP-003", 5, "Assigned",    "In Progress", "Contacted logistics partner for tracking update.", daysAgo(23)],
  ["CMP-003", 5, "In Progress", "Resolved",    "Package located at regional hub. Delivered on 2nd attempt.", daysAgo(22)],
  ["CMP-003", 5, "Resolved",    "Closed",      "Customer confirmed receipt. Case closed.", daysAgo(20)],

  // CMP-007 (In Progress)
  ["CMP-007", 3, null,       "Open",        "App crash reported on iOS.", daysAgo(3)],
  ["CMP-007", 3, "Open",     "Assigned",    "Assigned to Arjun Mehta.", daysAgo(2, 20)],
  ["CMP-007", 3, "Assigned", "In Progress", "Reproduced the crash locally on iOS 17.4. Filing bug with mobile team.", daysAgo(2)],

  // CMP-008 (Escalated)
  ["CMP-008", 4, null,       "Open",      "Fraudulent debit reported.", daysAgo(2)],
  ["CMP-008", 4, "Open",     "Assigned",  "Assigned to Priya Nair — critical billing case.", daysAgo(1, 22)],
  ["CMP-008", 4, "Assigned", "Escalated", "Escalated to supervisor: transaction under financial review. Amount: ₹15,000.", daysAgo(1)],

  // CMP-009 (Assigned)
  ["CMP-009", 5, null,    "Open",     "Non-delivery complaint filed.", daysAgo(1)],
  ["CMP-009", 5, "Open",  "Assigned", "Assigned to Karthik Rajan.", daysAgo(1, 10)],

  // CMP-010 (Pending Customer Response)
  ["CMP-010", 3, null,          "Open",                      "Headphone fault reported.", daysAgo(4)],
  ["CMP-010", 3, "Open",        "Assigned",                  "Assigned to Arjun Mehta.", daysAgo(3, 20)],
  ["CMP-010", 3, "Assigned",    "In Progress",               "Troubleshooting started. Requested purchase proof.", daysAgo(3)],
  ["CMP-010", 3, "In Progress", "Pending Customer Response", "Waiting for purchase receipt to process warranty claim.", daysAgo(2)],

  // CMP-014 (Escalated Critical)
  ["CMP-014", 5, null,      "Open",      "API failure reported.", daysAgo(1.5)],
  ["CMP-014", 5, "Open",    "Assigned",  "Assigned to Karthik Rajan — critical.", daysAgo(1.5, 8)],
  ["CMP-014", 5, "Assigned","Escalated", "Escalated: production system impact confirmed. Involving senior engineering.", daysAgo(1)],
];
...
// Get customer IDs
const anjali = db.prepare("SELECT id FROM users WHERE email = ?").get("anjali@email.com");
const rohit  = db.prepare("SELECT id FROM users WHERE email = ?").get("rohit@email.com");
const meena  = db.prepare("SELECT id FROM users WHERE email = ?").get("meena@email.com");
const vikram = db.prepare("SELECT id FROM users WHERE email = ?").get("vikram@email.com");
const sneha  = db.prepare("SELECT id FROM users WHERE email = ?").get("sneha@email.com");
...
const agent1 = db.prepare("SELECT id FROM users WHERE email = ?").get("agent1@ccrts.com");
const agent2 = db.prepare("SELECT id FROM users WHERE email = ?").get("agent2@ccrts.com");
const agent3 = db.prepare("SELECT id FROM users WHERE email = ?").get("agent3@ccrts.com");
const sup    = db.prepare("SELECT id FROM users WHERE email = ?").get("supervisor@ccrts.com");
const admin  = db.prepare("SELECT id FROM users WHERE email = ?").get("admin@ccrts.com");
...
const notifs = [
  ...
  [agent1.id, "CMP-015", "New complaint CMP-015 assigned to you: Delivery address change request.", 0, daysAgo(0.8)],
